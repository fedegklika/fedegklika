...
```ts
const federico = {
  approach: "ownership-first",
  delivery: "ship fast, iterate, document",
  communication: "direct, async, no meetings unless needed",
  infrastructure: "I build on your accounts — when I deliver, it's yours",
  followUp: "15 days of post-delivery support included, no extra cost",
};

federico.specialties = [
  "Turning messy briefs into shippable products",
  "Integrating systems that shouldn't talk (but need to)",
  "Delivering Shopify/WordPress projects with real UX impact",
  "Automating repetitive workflows into invisible infrastructure",
];
```
...
<div align="center">
  <i>⚡ "First principles, fewer meetings, shipping beats perfecting." ⚡</i>
</div>
